...
{
    public partial class BonLivraisonReport : XtraReport
    {
        public BonLivraisonReport(BonLivraisonFacture bonLivraison, List<LigneBonLivraisonFacture> lignes)
        {
            ...
            CreateReportBands(bonLivraison, lignes);
        }

        private void CreateReportBands(BonLivraisonFacture bonLivraison, List<LigneBonLivraisonFacture> lignes)
        {
            ...
            {
                Text = $"BON DE LIVRAISON N°{bonLivraison.NumeroBlf}",
            ...
            rowDate.Cells.Add(CreateTableCell("Date BL:", 100));
            rowDate.Cells.Add(CreateTableCell(bonLivraison.DateBlf.ToString("dd/MM/yyyy"), 200));
            ...
            rowClient.Cells.Add(CreateTableCell(
                $"{bonLivraison.CodeClient} - {bonLivraison.NomClient}", 300));
            tableInfos.Rows.Add(rowClient);

            var rowBC = new XRTableRow();
            rowBC.Cells.Add(CreateTableCell("Bon Commande:", 100));
            rowBC.Cells.Add(CreateTableCell(
                bonLivraison.NumeroBc?.ToString() ?? "N/A", 200));
            tableInfos.Rows.Add(rowBC);
            ...
            totalRow.Cells.Add(CreateTotalCell(bonLivraison.MontantTotal?.ToString("N2") + " DT", 100, TextAlignment.MiddleRight));
        ...
        private XRTable CreateLinesTable(List<LigneBonLivraisonFacture> lignes)
        {
